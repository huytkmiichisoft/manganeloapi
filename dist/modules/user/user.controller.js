...
let UserController = class UserController {
    ...
    async userRemoveDevices(user, dataRemove) {
...
__decorate([
    common_1.Post("remove-devices-user"),
    swagger_1.ApiOperation({ summary: "User Remove Devices When Logout" }),
    swagger_1.ApiResponse({ status: 200, description: 'User Remove Devices When Logout Success Fully.' }),
    role_decorators_1.Roles(role_type_1.RoleType.USER),
    common_1.UsePipes(new common_1.ValidationPipe({ transform: true })),
    __param(0, user_decorators_1.UserInfo()), __param(1, common_1.Body()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, user_dto_1.dtoRemoveDevicesUser]),
    __metadata("design:returntype", Promise)
], UserController.prototype, "userRemoveDevices", null);
__decorate([
