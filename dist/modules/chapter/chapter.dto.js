...
exports.dtoDeleteContentChapter = exports.dtoGetDetialChapter = exports.dtoGetListChapter = void 0;
...
__decorate([
    swagger_1.ApiProperty({ minimum: 1, example: 100 }),
    class_validator_1.IsNumber(),
...
class dtoDeleteContentChapter {
}
__decorate([
    swagger_1.ApiProperty({ title: "id of chapter" }),
    class_validator_1.IsMongoId(),
    __metadata("design:type", String)
], dtoDeleteContentChapter.prototype, "id", void 0);
exports.dtoDeleteContentChapter = dtoDeleteContentChapter;
