...
export declare class MangaController {
    ...
    userFollowManga(user: User, data: dtoUserFollowManga): Promise<ApiResult<unknown>>;
    userUnFollowManga(user: User, data: dtoUserUnFollowManga): Promise<ApiResult<unknown>>;
    suggestToManga(dataSuggest: dtoSuggestManga): Promise<ApiResult<unknown>>;
    hiddenMangaTop(): Promise<ApiResult<unknown>>;
    showAllManga(): Promise<ApiResult<unknown>>;
    setMangaSlide(): Promise<ApiResult<unknown>>;
}
